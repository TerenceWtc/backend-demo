...
/**
 * override Hibernate source code
 * to order the sort of columns when automatically create tables
 * changed TreeMap to LinkedHashMap
 * references from https://blog.csdn.net/Amaranth__/article/details/84930312
 */
